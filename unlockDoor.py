...
def launch():	
	return ask("Welcome, this is eye lock! You can ask me to turn the light on, about the weather, and lock or unlock the door!")
...
def doorUnlock():
	global isDoorOpen
	if (isDoorOpen == 1):
		return tell("The door is already open!")
